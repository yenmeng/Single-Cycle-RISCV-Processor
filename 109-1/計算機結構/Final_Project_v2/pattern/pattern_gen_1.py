...
class write_pattern(object):
    ...
    def write_line(self, str_in):
        ...
        counter_str = '{0:x}'.format(self.counter).zfill(2).upper()
        str_out = '{0}_{1}_{2}_{3}_{4}_{5}_{6}_{7} // '.format(substr_7, substr_6, substr_5, substr_4, substr_3, substr_2, substr_1, substr_0) + \
                  '{0}_{1}_{2}_{3}_{4}_{5}_{6}_{7} // '.format(substr_0, substr_1, substr_2, substr_3, substr_4, substr_5, substr_6, substr_7) + \
                  '0x{0}//'.format(counter_str)
...
def add_underline(str_in):
    ...
    substr_6 = str_in[12:14]
    substr_7 = str_in[14:16]
    return '{0}_{1}_{2}_{3}_{4}_{5}_{6}_{7} (hex)'.format(substr_0, substr_1, substr_2, substr_3, substr_4, substr_5, substr_6, substr_7)
...
if __name__ == '__main__':
    ...
    data1 = '{0:x}'.format(x).zfill(16).upper()
    data2 = '{0:x}'.format(y).zfill(16).upper()
    and_result = '{0:x}'.format(x & y).zfill(16).upper()
    or_result = '{0:x}'.format(x | y).zfill(16).upper()
    slt_result = '{0:x}'.format(x < y).zfill(16).upper()
    add_result = '{0:x}'.format(x + x).zfill(16).upper()
    sub_result = '{0:x}'.format(2*x - x).zfill(16).upper()
